...
'''
This script allows us to account for funk non-standard chaarcters in the filename
'''

# need to allow python to output utf8 in command line
...
def strip_text(file_txt):
    ...
    # until native way to do this in FFMPEG is found, this is the brute force method
    #
